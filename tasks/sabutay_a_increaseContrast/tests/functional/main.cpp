...
class SabutayAincreaseContrastFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_sabutay_a_increaseContrast, "pic_0.jpeg");
...
TEST_P(SabutayAincreaseContrastFuncTests, MatmulFromPic) {
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, SabutayAincreaseContrastFuncTests, kGtestValues, kPerfTestName);
