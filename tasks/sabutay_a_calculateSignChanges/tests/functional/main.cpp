...
class SabutayAcalculateSignChangesFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(SabutayAcalculateSignChangesFuncTests, MatmulFromPic) {
